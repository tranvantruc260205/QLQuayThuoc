namespace QLQuayThuoc
{
    partial class UCDuyetPhieuXinCap
    {
        ...
        private void InitializeComponent()
        {
            ...
            colMaLo = new DataGridViewComboBoxColumn();
            ...
            grpChiTietDuyet.Margin = new Padding(4, 4, 4, 4);
            grpChiTietDuyet.Name = "grpChiTietDuyet";
            grpChiTietDuyet.Padding = new Padding(4, 4, 4, 4);
            ...
            // btnDuyetXuat
            // 
            btnDuyetXuat.Location = new Point(558, 405);
            btnDuyetXuat.Margin = new Padding(4, 4, 4, 4);
            btnDuyetXuat.Name = "btnDuyetXuat";
            btnDuyetXuat.Size = new Size(200, 44);
            ...
            // btnInPhieu
            // 
            btnInPhieu.Location = new Point(390, 404);
            btnInPhieu.Margin = new Padding(4, 4, 4, 4);
            ...
            // btnTuChoi
            // 
            btnTuChoi.Location = new Point(216, 405);
            btnTuChoi.Margin = new Padding(4, 4, 4, 4);
            ...
            dgvChiTiet.Columns.AddRange(new DataGridViewColumn[] { colMaThuoc, colTenThuoc, colSoLuongYeuCau, colTonKho, colMaLo, colSoLuongDuyet });
            dgvChiTiet.Location = new Point(9, 92);
            ...
            txtGhiChuDuyet.Margin = new Padding(4, 4, 4, 4);
            txtGhiChuDuyet.Multiline = true;
            txtGhiChuDuyet.Name = "txtGhiChuDuyet";
            txtGhiChuDuyet.Size = new Size(746, 48);
            ...
            grpPhieuChoXuLy.Margin = new Padding(4, 4, 4, 4);
            grpPhieuChoXuLy.Name = "grpPhieuChoXuLy";
            grpPhieuChoXuLy.Padding = new Padding(4, 4, 4, 4);
            ...
            dgvPhieu.Margin = new Padding(4, 4, 4, 4);
            ...
            // colMaLo
            // 
            colMaLo.HeaderText = "Chọn lô xuất";
        ...
        private DataGridViewComboBoxColumn colMaLo;
