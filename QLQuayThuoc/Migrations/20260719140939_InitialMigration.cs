        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GiaNhap = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrangThai = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TongTienThuoc = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    TienBHYTThanhToan = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    TienBenhNhanTra = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    HinhThucThanhToan = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HoaDons_DonThuocs_MaDonThuoc",
                        column: x => x.MaDonThuoc,
                        principalTable: "DonThuocs",
                        principalColumn: "MaDonThuoc",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_HoaDons_Users_ThuNganId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HoaDons_MaDonThuoc",
                table: "HoaDons",
                column: "MaDonThuoc",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_HoaDons_ThuNganId",
                table: "HoaDons",
                column: "ThuNganId");
